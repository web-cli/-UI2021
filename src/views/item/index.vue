<template>
	...
	<div class="item_body">
		...
		<div class="bannerSwp">
			<van-swipe @change="onChange" :autoplay="2500">
		...
		<van-notice-bar left-icon="volume-o" :scrollable="false" >
		  ...
		  >
		    <van-swipe-item v-for="item in invest">{{item.phone}}成功投资{{item.money}}元在项目{{item.title}}</van-swipe-item>
		  </van-swipe>
		</van-notice-bar>
<!-- 		<div class="input_video">
		...
		<div class="zaitoudiv">
			<div class="img">
				<img style="height: 32px;margin-top: 20px;margin-bottom: 16px;" src="../index/image/huanbao/zaitou.png" alt="">
			</div>
		</div>
		<div class="mt0" v-for="item in data.list" @click="goToDetail(item.id,item.schedule)" >
			...
			<div class="outer_wrap">
				...
				<div class="btn_touzi" style="position: absolute;bottom: 0;" @click="goToDetail(item.id,item.schedule)" v-if="item.schedule !== 100">马上投资</div>
		...
		data() {
			return {
				playerOptions : {
				        ...
				        sources: [{
				          src: 'https://dongli1219.oss-cn-hangzhou.aliyuncs.com/99f234f4c150de9455218255be1fff4c.mp4',  // 路径
				          type: 'video/mp4'  // 类型
				        }],

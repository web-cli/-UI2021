        ...
        <form class="form" @submit.prevent="handleSubmit">
            ...
            <div class="item item_pwd">
                <div class="content">
                    ...
                    <input v-model.trim="data.password" autocomplete="off" class="inp" :type="psd" placeholder="请输入登录密码">
                    <span class="right_icon show_icon" :class="psd=='password'?'':'show'" @click="show_psd"></span>
                </div>
            </div>
            
            <label class="contract">
                <van-checkbox v-model="checked" icon-size="14px" sytle="color:#000;">我已阅读并同意</van-checkbox>
            ...
            <div class="item login_box">
				<van-button type="primary" class="btn basic_btn_v2" color="linear-gradient(to right, #1db8f7, #1464f3)" size="large">立即登录</van-button>

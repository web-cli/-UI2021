    ...
    <div class="main">
        ...
        <div class="form" >
            <div class="content clearfix">
                ...
                <input class="inp phone" id="phone" name="phone" type="text" v-model.trim="data.mobile"
                       placeholder="请输入手机号码">
            ...
            <div class="content clearfix">
                ...
                <input class="inp pwd" :type="psd" name="pwd" v-model.trim="data.password" placeholder="请设置登录密码">
                <span class="right_icon show_icon" :class="psd=='password'?'':'show'" @click="show_psd"></span>
            </div>
            <div class="content clearfix">
                <span class="left_icon pwd_icon"></span>
                <input class="inp pwd2" :type="psd" id="pwd2" name="pwd2" v-model.trim="data.spassword"
...
<!--            <div class="content clearfix">
            ...
            <div class="content clearfix">
                <input class="inp inp1" id="smsCode" name="smscode" v-model.trim="data.code" type="text"
                       placeholder="请输入短信验证码">
                <van-count-down :time="time"  @finish="timeCall">
                    <template v-slot="timeData">
							  <van-button round type="info"  @click="sendcode" size="normal">{{timeData.seconds > 0 ? timeData.seconds : '获取验证码'}}</van-button>
                    </template>
                </van-count-down>
            </div>
            <div class="content clearfix">
                <span class="left_icon invite_icon"></span>
                <input class="inp inp2" name="top" value="{$phone}" :readonly="is_t_inp" v-model.trim="data.t_mobile"
                       type="text"
            ...
            <label class="contract">
				...
				<router-link to="/art/12">《用户协议》</router-link>和<router-link to="/art/13">《隐私政策》</router-link>
			...
			<van-button type="primary" @click="handleSubmit" class="btn basic_btn_v2" color="linear-gradient(to right, #1db8f7, #1464f3)" size="large">立即注册</van-button>
...
<style lang="less" scoped>
    ...
    .main {
        ...
        .form .content .getsms {
            ...
            border-radius: 4px;
            text-align: center;
            background:linear-gradient(90deg,rgba(202,162,98,1) 0%,rgba(226,195,151,1) 100%);
            color: #7D5319;
            font-size: 14px;
        }
